...
class StoreUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'courier_profile' => 'nullable|array',
            ...
            'courier_profile.phone' => 'required_with:courier_profile|string|unique:courier_profiles,phone',
            'courier_profile.email' => 'required_with:courier_profile|email|unique:courier_profiles,email',
